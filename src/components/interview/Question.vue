  ...
  export default {
    ...
    computed: {
      ...
      timerDuration () {
        ...
        const qp = this.question.questionParameters.find(qp => qp.parameterId == PT.allowed_time && qp.val != 0)
        return qp ? +qp.val : 0
      },
      showTimer () {
      ...
      showTimerControls () {
        ...
        return this.question.questionParameters.findIndex(qp => qp.parameterId == PT.show_timer_controls && qp.val != false) > -1
      }
    },
    components: {
      AsyncTranslationText,
